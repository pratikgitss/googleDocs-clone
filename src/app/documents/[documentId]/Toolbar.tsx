  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80 overflow-hidden text-sm">
...
const FontSizeButton = () => {
  ...
  return (
    <div className="flex items-center gap-x-0.5">
      <button onClick={decrement} className="h-7 w-7 shrink-0 flex size-7 items-center justify-center rounded-sm hover:bg-neutral-200">
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="h-7 w-10 cursor-text border border-neutral-400 text-center text-sm rounded-sm bg-transparent"
        >
          {currentFontSize}
        </button>
      )}
